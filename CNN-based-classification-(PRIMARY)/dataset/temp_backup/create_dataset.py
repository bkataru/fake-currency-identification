...
def main(dataset_type):
    for fold in folders:
        ...
        if dataset_type == 'training_set':
            generate_images(pr_list, 150, "PR", False)
            generate_images(ot_list, 50, "OT", False)
            generate_images(pr_list, 150, "PR", True)
            generate_images(ot_list, 50, "OT", True)
        elif dataset_type == 'test_set':
            generate_images(pr_list, 75, "PR", False)
            generate_images(ot_list, 25, "OT", False)
            generate_images(pr_list, 75, "PR", True)
            generate_images(ot_list, 25, "OT", True)
