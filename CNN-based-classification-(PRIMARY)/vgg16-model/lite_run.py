...
interpreter = tf.lite.Interpreter(model_path="converted_currency_vgg16model.tflite")
...
f = open("vgg16_currency_class_indices.txt", "r")
labels = f.read()
...
print('=' * 50)
print(predict_image('..\\test-images\\2.jpg', False))
# verify_test_dir()
