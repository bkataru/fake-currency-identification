...
def main(dataset_type):
    for fold in folders:
        ...
        def generate_images(img_list, num, id, inverted_flag):
            ...
            for img_ind in range(0, len(img_list)):
                ...
                for iter in range(1, iterations + 1):
                    ...
                    if inverted_flag:
                        cv2.imwrite('.\\{}\\{}\\wtdown-{}-{}-{}.jpg'.format(dataset_type, fold, id, iter, UNIQUE), image)
                    else:
                        cv2.imwrite('.\\{}\\{}\\wtup-{}-{}-{}.jpg'.format(dataset_type, fold, id, iter, UNIQUE), image)
                ...
                if rem != 0:
                    for rem_iter in range(1, rem + 1):
                        ...
                        if inverted_flag:
                            cv2.imwrite('.\\{}\\{}\\wtdown-{}-{}-rem.jpg'.format(dataset_type, fold, id, rem_iter), image)
                        else:
                            cv2.imwrite('.\\{}\\{}\\wtup-{}-{}-rem.jpg'.format(dataset_type, fold, id, rem_iter), image)
        ...
        if dataset_type == 'training_set':
            generate_images(files, training_count, "WT", False)
            generate_images(files, training_count, "WT", True)
        elif dataset_type == 'test_set':
            generate_images(files, test_count, "WT", False)
            generate_images(files, test_count, "WT", True)
