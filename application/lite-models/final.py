...
classify_interpreter = tf.lite.Interpreter(model_path="converted_currency_model.tflite")
watermark_interpreter = tf.lite.Interpreter(model_path="converted_watermark_model.tflite")
uv_interpreter = tf.lite.Interpreter(model_path="converted_uv_model.tflite")
