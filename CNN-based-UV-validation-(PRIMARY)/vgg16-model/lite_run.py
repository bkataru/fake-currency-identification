...
interpreter = tf.lite.Interpreter(model_path="converted_uv_vgg16model.tflite")
...
f = open("vgg16_uv_class_indices.txt", "r")
labels = f.read()
...
print('=' * 50)
print(predict_image('..\\test-images\\testfake.jpg'), False)
#verify_test_dir()
