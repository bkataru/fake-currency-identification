...
def modify_image(img_name, inverted_flag):
...
def main(dataset_type):
    for fold in folders:
        ...
        def generate_images(img_list, num, id, inverted_flag):
            ...
            for img_ind in range(0, len(img_list)):
                ...
                for iter in range(1, iterations + 1):
                    image = modify_image('.\\comp_data\\' + fold + '\\' + img_list[img_ind], inverted_flag)
                    if inverted_flag:
                ...
                if rem != 0:
                    for rem_iter in range(1, rem + 1):
                        image = modify_image('.\\comp_data\\' + fold + '\\' + img_list[0], inverted_flag)
                        if inverted_flag:
        ...
        if dataset_type == 'training_set':
            generate_images(files, training_count, "UV", False)
            generate_images(files, training_count, "UV", True)
        elif dataset_type == 'test_set':
            generate_images(files, test_count, "UV", False)
            generate_images(files, test_count, "UV", True)
